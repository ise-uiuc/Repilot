...
class SpanLM(object):
    ...
    def model_predict(self, prefix: str, suffix: str, do_sample=False, use_max_length=False, buggy: str = "", num_samples=1000, strict=False):
        ...
        with torch.no_grad():
            ...
            if 'Salesforce' in self.pretrained:
                ...
                for index, output in enumerate(outputs):
                    ...
                    if strict and (self.EOM not in output):
                        print("EOM not in")
                        continue
